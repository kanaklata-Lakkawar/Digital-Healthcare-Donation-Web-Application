...
<nav class="navbar navbar-expand-sm navbar-dark">
    <div class="container-fluid">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="requestMedicine.jsp">Request Medicine</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="viewAllDonations.jsp">View Donations</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="trackMedicine.jsp">Track Request Medicine</a>
            </li>
        </ul>
