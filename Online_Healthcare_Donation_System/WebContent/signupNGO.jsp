...
<div class="container" style='margin-top: 60px;'>
  ...
  <h4 style='text-align: center;'>Signup as NGO</h4>
  <form action="signupngoserv">
    ...
    <!-- <label for="fname">Name:</label> -->  
      <input type="fname" class="form-control" id="fname" placeholder="Enter First Name" name="name" required >
    </div>
...
<!--   <label for="lname">Name:</label> -->
   ...
   <!-- <label for="idproof">Id Proof :</label> -->
      <input type="ngo" class="form-control" id="ngo" placeholder="Enter NGO name" name="ngo" required >
    </div>
